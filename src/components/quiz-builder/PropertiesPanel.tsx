...
export function PropertiesPanel() {
  ...
  const handleBackgroundColorToggle = () => {
    if (commonProperties.styles?.backgroundColor) {
  ...
  return (
    <div className="space-y-0">
      ...
      <PropertyGroup 
        ...
        className={commonProperties.styles?.backgroundColor ? "" : "property-group-no-content"}
        action={
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  {commonProperties.styles?.backgroundColor ? 
              ...
              <TooltipContent>
                {commonProperties.styles?.backgroundColor ? "Remove background" : "Add background"}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        }
          ...
          <div className="property-group-content">
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input 
                  id="background-image" 
                  value={commonProperties.styles?.backgroundImage?.replace('url(', '').replace(')', '') || ''}
