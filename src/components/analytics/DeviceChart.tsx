...
export function DeviceChart() {
  ...
  React.useEffect(() => {
    ...
    const deviceColors = {
      desktop: "#355DF9", // Primary blue
      mobile: "#22C55E",  // Green
      tablet: "#EAB308",  // Yellow
      other: "#9333EA"    // Purple
    };
    
    // Convert to chart data format
    const chartData = [
      { device: "desktop", count: desktopCount, fill: deviceColors.desktop },
      { device: "mobile", count: mobileCount, fill: deviceColors.mobile },
      { device: "tablet", count: tabletCount, fill: deviceColors.tablet },
      { device: "other", count: otherCount, fill: deviceColors.other }
