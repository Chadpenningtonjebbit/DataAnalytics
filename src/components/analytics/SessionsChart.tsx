...
export function SessionsChart() {
  ...
  React.useEffect(() => {
    ...
    const chartData = [
      { type: "completed", sessions: completions, fill: "#355DF9" }, // Primary blue
      { type: "incomplete", sessions: sessions - completions, fill: "#8EABFF" } // Lighter blue
    ]
